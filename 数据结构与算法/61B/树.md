...
***Preorder traversal***: We trace a path around the graph, from the topgoing counter-clockwise. "Visit" every time we pass the LEFT of a node.
***Inorder traversal***: “Visit" when you cross the bottom of a node，
***Postorder traversal***: “Visit" when you cross the right a node，如果想要打印该结点，得先打印左子树与右子树

关于后序遍历的一个有趣可视化，即从左下角开始绕着框框打印结点，4-7-8-5-2-9-6-3-1
